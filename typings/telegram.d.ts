...
export declare class Telegram extends ApiClient {
     ...
     */
    sendRichMessage(chatId: number | string, richMessage: tg.InputRichMessage, extra?: tt.ExtraSendRichMessage): Promise<never>;
    /**
     * Stream a partial rich message draft (private chats only).
     * The draft is ephemeral (30s preview) — must finalize with sendRichMessage.
     * @param chatId  Private chat ID (integer only)
     * @param draftId Non-zero draft ID; same ID animates between updates
